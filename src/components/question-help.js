...
class QuestionHelp extends Component {
    ...
    getHelp(type) {
        switch (type) {
            case "board":
                this.setState({helpType: type, message: 'Hint', showDialog: true, boardEnable: false});
                break;
            case "deck":
                this.setState({helpType: type, message: 'Helpline', showDialog: true, deckEnable: false});
                break;
            case "guess":
                this.setState({helpType: type, message: 'Guests', showDialog: true, guessEnable: false});
                break;
        }
    };
